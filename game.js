...
const CAND_IDS = ["shion", "ren", "haru", "kai", "sora", "takuto", "hara", "noa", "roi", "masaki", "shuto", "shino"];
...
/* ================= 復習タイム（解説ドラマ→リベンジ） ================= */
const MENTOR_G = { pi: "kai", frac: "nosuke", ratio: "haru", gyaku: "ren", kufuu: "riku", bun: "kanade" };
const MENTOR_INTRO = {
