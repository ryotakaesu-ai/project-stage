...
const JCOMMENT = {
  tsukasa: [[85, ["「文句なし。おまえ、化けたな」", "「……鳥肌が立った。プロの顔だ」", "「完璧を求めてきたが……これは、その先だ」"]],
            [70, ["「悪くない。だが、まだ足りない」", "「伸びてる。……が、おれの目はごまかせない」"]],
            [55, ["「もっとやれるはずだ。見せてみろ」", "「本気はそんなものか？ ……違うだろ」"]],
            [0,  ["「……このままだと、落ちるぞ」", "「今日は届かなかった。……明日はどうする？」"]]],
  kanade:  [[85, ["「その表情、すごくよかった。伝わってきたよ」", "「見ていて涙が出そうになった。本物だよ」", "「きみのステージには、物語がある」"]],
            [70, ["「がんばってるのが見えた。自信を持って」", "「あと一歩で化ける。楽しみだなあ」"]],
            [55, ["「ちょっと固かったかな。楽しんでいこう」", "「緊張してたね。でも、それは本気の証拠」"]],
            [0,  ["「無理してない？ 大丈夫？」", "「今日の悔しさは、次の宝物になるよ」"]]],
  riku:    [[85, ["「やべぇ。おまえのダンス、目が離せない」", "「会場ぜんぶ、おまえのものだったな」", "「……正直、おれでも勝てるか怪しい」"]],
            [70, ["「キレは出てきた。あとは体幹だな」", "「おっ、化けはじめたね。いいよいいよ」"]],
            [55, ["「リズム、まだ走ってる。落ち着け」", "「惜しい！ 音をもっと聴け、音を」"]],
            [0,  ["「基礎からやり直しだな、これは」", "「今日はダメだった。で、明日は何時に来る？」"]]],
};
...
const EVENTS = [
  ...
  { id: "e20", c: "riku", t: "「よう。おまえ、ダンスの動画投稿とかやんないの？\nおれが撮ってやるよ。バズる角度、知ってるし」", ch: [
...
function cheerLine() {
  ...
  const judges = hot
    ? ["司「……ほう」", "奏「すごい、目が離せない」", "陸「会場わいてるよ！」", "司「……面白くなってきた」"]
    : ["司「……続けろ」", "奏「いいよ、その調子」", "陸「キレてるねぇ！」", "奏「うん、きれい」"];
...
const MILE_EV = {
  20:  { c: "sora",    t: "「{name}くん、もう20問！ はやい！\n……ぼく、決めました。{name}くんのペースについていきます。\n最初のライバル宣言です！」" },
...
const MENTOR_LOSE = {
  ...
  riku: ["「ん、まだ体に入ってないな。", "「筋肉痛と同じ。効いてる証拠だよ。"],
