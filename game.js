...
const CANDS = {
  ...
  noa:   { n: "ノア",   full: "乃亜 / 17", img: "img/noa.jpg",   c: "#7ee0e6", role: "マイペースな帰国子女" },
  roi:   { n: "ロイ",   full: "路衣 / 18", img: "img/roi.jpg",   c: "#e0a34a", role: "おしゃれ番長・自称パリコレ級" },
  masaki:{ n: "マサキ", full: "将希 / 18", img: "img/masaki.jpg", c: "#8fd0ff", role: "正統派王子・努力家" },
  shuto: { n: "シュウト", full: "周斗 / 16", img: "img/shuto.jpg", c: "#ffb35c", role: "いたずらっ子・運動神経の塊" },
  shino: { n: "シノ",   full: "紫乃 / 16", img: "img/shino.jpg", c: "#c9b8ff", role: "無口な大器晩成の天才" },
};
