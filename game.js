...
const NICHI_SCENES = [
  "（休憩時間、あかりとゆりあが目を輝かせて詰め寄ってきた）\n\nあかり「あの、わたしたち、タイムレッスーの大ファンなんです！」\nゆりあ「……ずっと、応援してます」\n\nあかり「フマさんのリーダーとしての言葉が好きで！\nショリさんのビジュアルは人間国宝で！\nソウさんの『おいしー！』が可愛くて！」\n\nゆりあ「あかり、早口になってる」\nあかり「だって好きなんだもん！」\n\n（ふたりは知らない。目の前にいるのが、\nその3人に選ばれようとしている候補生だということを）\n\nあかり「……あ。もしかして、お兄ちゃんたちも、タイムレッスー好きですか？」\n\n——好き、なんてものじゃない。\n人生を懸けている。",
  "ゆりあ「あの……ひとつだけ、聞いてもいいですか。\n\nわたし、勉強するとき、いつもタイムレッスーの曲を聴いてるんです。\n『RUN』。走る曲。\n\n……この曲を聴くと、まだ走れるって思えるんです。\nテストで最悪の点を取った日も、この曲だけは裏切らなかった」\n\nあかり「わたしも。塾のカバンに、ずっと缶バッジつけてる」\n\nゆりあ「……アイドルって、すごいですよね。\n会ったこともない人を、こんなに助けられるんだから」\n\n（その言葉を、一生忘れないと思った。\n自分がなろうとしているのは、そういう存在なのだ）",
  "（帰り際、ゆりあがこっそり呼び止めてきた）\n\nゆりあ「あかりの前では言えなかったんですけど……\nわたし、ほんとは、いちばんのファンなんです」\n\n（差し出されたノートには、タイムレッスーの歌詞がびっしり書き写されていた。\n漢字の練習を兼ねて、何十ページも）\n\nゆりあ「歌詞を書き写すと、漢字も覚えられるし、元気も出るから。\n一石二鳥って、こういうことだと思います」\n\n「……ずるいですよね。好きなことを、勉強にしちゃうの」\n\n「ずるくない。……天才だと思う」\n\nゆりあは、耳まで赤くなって、走って行ってしまった。",
...
function startNichinoken(done) {
  ...
  showEvent({
    ...
    ch: [{ t: "📚 目黒校へ！", fx: {}, after: () => {
      ...
      /* 初回だけ：あかり＆ゆりあの「推し語り」→無邪気な一撃（固定） */
      const goOshi = () => {
        if (DB.meta.oshiSeen) return goScene();
        DB.meta.oshiSeen = true; save();
        showEvent({
          c: spk,
          t: "あかり「お兄ちゃんたちって、オーディション受けてるんですよね。\n\n……ってことは、受かったら、タイムレッスーに入るんですか？」\n\n「……そうだよ」\n\nあかり「え。……え！？」\nゆりあ「……うそ。じゃあ、わたしたち、いま」\nあかり「未来のタイムレッスーに、推し語りしちゃった！？」\n\n（ふたりは真っ赤になって、手で顔をおおった）\n\nしばらくして、あかりが指のすきまから言った。\n\n「……じゃあ、お願いがあります。\n\n　ぜったい、受かってください。\n　わたしの推しが、5人に増えるので」\n\n——20,000人という数字より、\nその一言のほうが、ずっと重かった。",
          ch: [
            { t: "「……重い。でも、うれしい」", fx: { st: { me: 7 }, fans: 900 }, after: goScene },
            { t: "「必ず、5人目になる」", fx: { st: { me: 6, ex: 3 }, fans: 1200 }, after: goScene },
          ]
        });
      };
      if (tIdx >= 0) showEvent({
        c: "shino",
        t: NICHI_AKARI[tIdx],
        ch: [{ t: "▶", fx: { st: { me: 3 }, aff: { shino: 4 }, silent: true, msg: "シノとあかりの時間" }, after: goOshi }]
      });
      else goOshi();
    } }]
  });
